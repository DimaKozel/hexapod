import { MPU6050, Utils } from "@ros2jsguy/mpu6050-motion-data";
...
//   }
  ...
  imu.dmpInitialize();
  imu.calibrateAccel();
//   imu.calibrateGyro(); // Error in PI offset calculation: The value of "value" is out of range. It must be >= 0 and <= 65535. Received -17
