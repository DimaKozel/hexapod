...
class Color {
    ...
    lerpHSL(color, alpha) {
        this.getHSL(_hslA);
        color.getHSL(_hslB);
        const h = MathUtils_1.MathUtils.lerp(_hslA.h, _hslB.h, alpha);
        const s = MathUtils_1.MathUtils.lerp(_hslA.s, _hslB.s, alpha);
        const l = MathUtils_1.MathUtils.lerp(_hslA.l, _hslB.l, alpha);
        this.setHSL(h, s, l);
        return this;
    }
    equals(c) {
