...
const _box = new Box3_1.Box3();
const _v1 = new Vector3_1.Vector3();
const _toFarthestPoint = new Vector3_1.Vector3();
const _toPoint = new Vector3_1.Vector3();
class Sphere {
    constructor(center = new Vector3_1.Vector3(), radius = -1) {
        this.isSphere = true;
        this.center = center;
        this.radius = radius;
    }
