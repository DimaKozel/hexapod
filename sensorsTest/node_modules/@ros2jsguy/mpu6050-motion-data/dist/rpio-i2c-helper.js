 ...
 */
class RpioI2CHelper {
    constructor(baudRate, regBufferSize = DEFAULT_REGBUF_SZ, dataBufferSize = DEFAULT_DATABUF_SZ) {
        // configure RPIO
     ...
     */
    readBit(deviceAddr, regAddr, bitNum) {
     ...
     */
    readBits(deviceAddr, regAddr, bitStart, length) {
     ...
     */
    readBytes(deviceAddr, regAddr, byteCnt) {
    ...
    /**
      ...
      */
    writeBit(deviceAddr, regAddr, bitNum, data) {
        let b = this.readByte(deviceAddr, regAddr);
     ...
     * @returns Status of operation (0 = success)
     */
    writeBits(deviceAddr, regAddr, bitStart, length, bits) {
        //      010 value to write
     ...
     * @returns Status of operation (0 = success)
     */
    writeByte(deviceAddr, regAddr, data) {
     ...
     * @returns Status of operation (0 = success)
     */
    writeBytes(deviceAddr, regAddr, length, data) {
        // identify register and data to write
        this.dataBuffer.writeUInt8(regAddr, 0);
     ...
     * @returns Status of operation (0 = success)
     */
    writeWord(deviceAddr, regAddr, data) {
        // identify register and data to write
        this.dataBuffer.writeUInt8(regAddr, 0);
...
exports.RpioI2CHelper = RpioI2CHelper;
//# sourceMappingURL=rpio-i2c-helper.js.map